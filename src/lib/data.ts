...
export const projects: Project[] = [
  {
    slug: "obnl-presence-web",
    title: "Présence web pour un OBNL",
    tag: "PRÉSENCE WEB",
    tagBg: "#e7eaff",
    tagColor: "#3b46e0",
    desc: "Site vitrine professionnel conçu de A à Z pour un OBNL — design soigné, adapté au mobile, formulaires de contact intégrés et hébergement configuré. Livré en temps et en budget.",
    chips: ["Site vitrine", "OBNL", "Mobile"],
    cta: "Voir l'étude de cas",
    linkColor: "#1a60f5",
    imageAlt: "Capture du site web de l'OBNL",
  },
  {
...
export const services: Service[] = [
  ...
  },
  {
    ...
    iconPath: 'c-circle-4|M12 2v2M12 20v2M2 12h2M20 12h2M5 5l1.5 1.5M17.5 17.5 19 19M19 5l-1.5 1.5M6.5 17.5 5 19',
  },
  {
...
export const caseStudies: CaseStudy[] = [
  {
    slug: "obnl-presence-web",
    title: "Présence web pour un OBNL",
    tag: "Présence web professionnelle",
    challenge:
      "L'organisme avait un site désuet, peu visible en ligne et impossible à mettre à jour. Les inscriptions et demandes d'information arrivaient par appels téléphoniques chronophages.",
    solution:
      "Conception complète d'un nouveau site vitrine : architecture claire, design soigné, adapté au mobile, formulaires de contact en ligne, hébergement et configuration du nom de domaine. Le tout livré clé en main.",
    result:
      "Réduction marquée des appels manuels grâce aux formulaires en ligne — un système de prise de contact dont un cabinet comptable bénéficie au quotidien — et image en ligne enfin à la hauteur de la mission de l'organisme.",
    tech: ["Next.js", "Tailwind CSS", "Formulaires sécurisés", "Hébergement Vercel"],
  },
  {
    slug: "application-web-sur-mesure",
    title: "Application web sur mesure",
