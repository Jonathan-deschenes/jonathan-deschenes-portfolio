    ...
    <>
      ...
      <main>
        ...
        <section className="container-x pb-14 sm:pb-20 grid gap-6 sm:gap-10">
          ...
          <div className="bg-navy text-white rounded-[16px] sm:rounded-[18px] p-6 sm:p-8 max-w-[600px]">
            <h2 className="text-[18px] sm:text-[20px] mb-2.5 sm:mb-3 font-semibold">
              Vous préférez parler directement ?
            </h2>
            <p className="text-[#aab0bb] mb-4 sm:mb-5 leading-[1.6] text-[14px] sm:text-[15px]">
